    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('jersey', 'Jersey'), ('training', 'Training'), ('casual', 'Casual'), ('accessories', 'Accessories')], default='jersey', max_length=50)),
                ('season', models.CharField(blank=True, choices=[('2023-24', '2023-24'), ('2024-25', '2024-25'), ('2025-26', '2025-26')], max_length=20)),
